# Distribution Guide - bramclaw-gmail
...
```bash
cd /Users/jimeny/git/bram-claw/.claude/skills/bramclaw-gmail
...
**Output:**
- `bramclaw-gmail.skill` - Packaged skill file
- Includes: SKILL.md, scripts/, references/, tests/, assets/, CHANGELOG.md

### Verify Package

```bash
# Check package contents
unzip -l bramclaw-gmail.skill

# Should contain:
# - SKILL.md
# - scripts/gmail_agent.py
...
ln -s /path/to/bramclaw-gmail ~/.claude/skills/bramclaw-gmail
```
...
claude skill list | grep bramclaw-gmail

# Test in Claude session
# Ask: "Show me recent Gmail subjects"
...
git tag -a v2.0.0-gmail -m "bramclaw-gmail v2.0.0 - Progressive disclosure refactor"
git push origin v2.0.0-gmail

# Create GitHub release
gh release create v2.0.0-gmail \
  --title "bramclaw-gmail v2.0.0" \
  --notes-file .claude/skills/bramclaw-gmail/CHANGELOG.md \
  .claude/skills/bramclaw-gmail.skill
```
...
- [ ] Skill packaged (bramclaw-gmail.skill created)
- [ ] Git tag created
...
## [2.1.0] - 2026-03-01
### Added
- New search helper functions

# 3. Commit
git add .claude/skills/bramclaw-gmail/
git commit -m "chore(gmail): bump version to 2.1.0"

# 4. Tag and release
git tag v2.1.0-gmail
git push origin v2.1.0-gmail
gh release create v2.1.0-gmail ...
```
...
curl -L -o bramclaw-gmail.skill \
  https://github.com/bramforth/bram-claw/releases/download/v2.0.0-gmail/bramclaw-gmail.skill
...
ln -s $(pwd)/bram-claw/.claude/skills/bramclaw-gmail ~/.claude/skills/bramclaw-gmail
```
...
claude skill install anthropic/bramclaw-gmail
```
